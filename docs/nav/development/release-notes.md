...
- [⚙️ Feature: Per-role model fallback chains for Agent (#1)](https://github.com/dotflow-io/pycodeloop/pull/5)
- [🪲 Bug: Parse fenced tool calls a model narrates as prose (#2)](https://github.com/dotflow-io/pycodeloop/pull/6)
