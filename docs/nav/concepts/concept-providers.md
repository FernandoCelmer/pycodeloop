...
A config file (see [`templates/`](../../../templates) for ready-made ones — `anthropic.json`, `openai.json`, `ollama.json`, `lmstudio.json` — and [`reference.json`](../../../templates/reference.json) for every field) declares:
