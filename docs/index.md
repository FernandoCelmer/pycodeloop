...
<div align="center">
  <a aria-label="Repository" href="https://github.com/FernandoCelmer/pycodeloop">Repository</a>
  &nbsp;•&nbsp;
...
![GitHub last commit](https://img.shields.io/github/last-commit/FernandoCelmer/pycodeloop?style=flat-square)
...
Every piece is injected, not hardcoded: swap the LLM backend, the tool set, or the system prompt without touching the agent loop. Bare `pycodeloop` starts a full-screen Textual TUI; `run` covers one-shot and scripted use. Skills already on disk (Claude Code, Cursor, `AGENTS.md`) are discovered automatically.
...
- ⚠️ [Security Issue](https://github.com/FernandoCelmer/pycodeloop/issues/new/choose)
